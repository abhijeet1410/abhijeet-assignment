...
class AppPlacePicker extends StatefulWidget {
  ...
  AppPlacePicker(this.apiKey,
      {Key? key, this.displayLocation, this.localizationItem})
      : super(key: key) {
    localizationItem ??= LocalizationItem();
  }

  @override
  State<StatefulWidget> createState() => AppPlacePickerState();
}

/// Place picker state
class AppPlacePickerState extends State<AppPlacePicker> {
